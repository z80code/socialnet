...
public class UserData {
    ...
    public static final String USERDATA_HASH = "userdata_hash";
    ...
    public static final String USERDATA_GROUPS = "userdata_groups";
    ...
    private String userdata_groups;
    private String userdata_hobby;

    public UserData(int userdata_id, String userdata_hash, String userdata_firstname, String userdata_lastname, String userdata_email, String userdata_groups, String userdata_hobby) {
        ...
        this.userdata_groups = userdata_groups;
    ...
    public String getUserdata_groups() {
        return userdata_groups;
    }
    ...
    public void setUserdata_groups(String userdata_groups) {
        this.userdata_groups = userdata_groups;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (getUserdata_hash() != null ? !getUserdata_hash().equals(userData.getUserdata_hash()) : userData.getUserdata_hash() != null)
            return false;
        ...
        if (getUserdata_email() != null ? !getUserdata_email().equals(userData.getUserdata_email()) : userData.getUserdata_email() != null)
            return false;
        if (getUserdata_groups() != null ? !getUserdata_groups().equals(userData.getUserdata_groups()) : userData.getUserdata_groups() != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (getUserdata_groups() != null ? getUserdata_groups().hashCode() : 0);
